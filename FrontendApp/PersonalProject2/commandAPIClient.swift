//
//  commandAPIClient.swift
//  PersonalProject2
//
//  Created by C4Q on 10/6/18.
...
//struct CommandAPIClient {
//  private init() {}
//  static let manager = CommandAPIClient()
//
//  func postnewCommandToServer(event: Command, completionHandler: @escaping (URLResponse) -> Void, errorHandler: @escaping (Error) -> Void) {
